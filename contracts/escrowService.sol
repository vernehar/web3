...
//This is a simple escrow service contract. Buyers of products can send the agreed amount to the contract
//seller can then verify that the contract hold the transaction and the funds can only be directed to his address
